...
param.list <- list(NPL = 2, ISMPPRIOR = 0, IEXCHANGE = 1, NDAT_RT = NSrc,
                   NMODE = 1, NSRC=NSrc,NLMX = NLayersMax, NLMN = 1, ICHAINTHIN = 5,
...
makeParameterFile(param.list = param.list,output.file = '~/RayTracerFortran/RayTracer/test_1/test_X_parameter.dat')
